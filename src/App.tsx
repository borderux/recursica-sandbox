          ...
          <Box style={{ maxWidth: "800px", margin: "0 auto", textAlign: "center" }}>
            ...
            <Box style={{ maxWidth: "600px", margin: "0 auto" }}>
              <Typography variant="body-1/normal" color="color/gray/600">
                Request a custom button color for your project. Submit your details and we'll create a GitHub issue to track your request.
              </Typography>
            </Box>
          </Box>
        </Box>
          ...
          <Box style={{ maxWidth: "600px", margin: "0 auto" }}>
              ...
              >
                ...
                <Box style={{ marginBottom: "8px" }}>
                  <Typography color="color/salmon/700">
                    GitHub token is not configured. Please set the VITE_GITHUB_TOKEN environment variable.
                  </Typography>
                </Box>
              ...
              <form onSubmit={handleSubmit}>
                <Flex direction="column" gap="size/spacer/3x">
                  ...
                  <Box>
                    ...
                    {/* Color Preview */}
                    {formData.buttonColor && formData.buttonColor.match(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})$/) && (
              ...
              >
                ...
                <Box style={{ marginBottom: "8px" }}>
                  <Typography color="color/greensheen/700">
                    Your button color request has been created as a GitHub issue and will be reviewed by our team.
                  </Typography>
                </Box>
                {prUrl && (
                  <Box>
            ...
            {submitStatus === 'error' && (
              ...
              >
                ...
                <Box style={{ marginBottom: "8px" }}>
                  <Typography color="color/salmon/700">
                    There was an error submitting your color request. Please check your input and try again.
                  </Typography>
                </Box>
                {errorMessage && (
                  <Typography variant="body-2/normal" color="color/salmon/600">
